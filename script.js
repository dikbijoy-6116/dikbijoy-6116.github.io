/* =====================================================
   DIKBIJOY BONIK — PORTFOLIO JAVASCRIPT
   ===================================================== */
...
/*
   To add a real project image later, the HTML can use:
   ...
   <video controls>
     <source src="videos/project-1.mp4"
             type="video/mp4">
   </video>

   To add a project report:

   <a href="reports/project-1.pdf"
      target="_blank">
      View Report
   </a>
*/
...
console.log(
  "Dikbijoy Bonik Portfolio — System Online."
);
